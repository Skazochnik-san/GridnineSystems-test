...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        segmentFilter.getSetDepartureUntilTheCurrentTime(flightList);
        System.out.println("Filter number - 2. Segments with arrival date is before than departure time");
        System.out.println("---------------------------------------------------------------------------");
        segmentFilter.getSetArrivalBeforeDepartureDate(flightList);
        System.out.println("Filter number - 3. Transfer time is more than two hours");
        System.out.println("---------------------------------------------------------------------------");
        segmentFilter.getSetTimeOnEarthExceededByTwoHours(flightList);
